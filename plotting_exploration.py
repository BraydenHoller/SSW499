...
xrds = xr.open_dataset("SSWC_v1.0_geopClimMean_ERAi_s19790101_e20140630_c20160701.nc")

# print(xrds['geopClimMean'].values)

# xrds['geopClimMean'].plot() # plots all even NaN vals

# # xr.plot.line(xrds['geopClimMean'].dropna('timeClim')) # not useful cause dataset is 4D but good to know
...
print(xrds['geopClimMean']) # What does my data look like
'''
...
clim_mean_test = xrds['geopClimMean'][0,-1,:,:]
