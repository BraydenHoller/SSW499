...
def count_grid_points(file_path):
    ...
    # pres_dim = dataset.dimensions['pressure_level'].size
    time_dim = dataset.dimensions['valid_time'].size
...
file_path = r"C:\Users\Brayden.Holler\OneDrive - afacademy.af.edu\Documents\GitHub\499\Data\Snow_2223.nc"  # Replace with your file path
