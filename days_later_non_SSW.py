...
ds = xr.open_dataset(r"C:\Users\Brayden.Holler\OneDrive - afacademy.af.edu\Documents\GitHub\499\Data\non_SSWs_stereo.nc")
...
# Add a title
ax.set_title(f'5400 m Thickness Contours Jan 05 on Non SSW Years')
