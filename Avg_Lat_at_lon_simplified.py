...
average latitude at every 10° longitude for SSW and non‑SSW dates
...
# 1. Load the NetCDF file (must contain an 'avg_latitude' variable)
...
avg_lat   = ds['average_latitude'].values     # shape (num_dates, num_lon_bins)
...
# for SSW events
ev_matrix = avg_lat[ev_idx, :]            # (num_events, num_lon_bins)
...
# Scatter the average‑lat points
...
ax.set_title('Average 5400 m Contour Latitude at 10° Lon Intervals\n'
