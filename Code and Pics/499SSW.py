...
file_path = Path(r"C:\Users\Brayden.Holler\OneDrive - afacademy.af.edu\Documents\GitHub\499\Snow_2223.nc")
...
# climMean = data.data_vars['geopClimMean'].values # gets an indiv variable vals
# print(climMean)

mean_var_attributes = data.data_vars['sf'].attrs # looks at a vars attrs
